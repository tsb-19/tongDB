...
namespace antlr4 {
   ...
   *
   * <p>
   * You can insertData stuff, replace, and delete chunks. Note that the operations
   ...
   * not screw up the token index values. That is, an insertData operation at token
  ...
  protected:
    ...
    ///
    ///  I.i.u R.x-y.v | i in (x+1)-y           delete I (since insertData before
    ...
    ///
    ///  I.i.u = insertData u before op @ index i
    ...
    ///         insertData with replace and delete this replace.
